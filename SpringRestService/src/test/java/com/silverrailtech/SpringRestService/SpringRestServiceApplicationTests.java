...
public class TestStringStateAPI {
	...
	public void verifyInvalidPO() throws Exception {
		String character = "a";
		String amount = "2";
		mock.perform(MockMvcRequestBuilders.post("/test/char")//.accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON).content("{\"character\":\""+character+"\",\"amount\":\""+amount+"\"}")
